...
| `rxc-forms-v2-poc` | `poc/forms-v2` | **Throwaway.** Vite app that builds the `docs/FORMS-V2-INTERFACES.md` contract four ways over — plain HTML, MUI, Ant, Mantine — with field, options, collection, group, action and display boundaries, a tab container, a wizard, a staged-edit modal and a JSON loader. Its README carries the findings; the doc carries what they changed. Port 5183. Owes the rest of the repo nothing and is expected to be deleted. |
